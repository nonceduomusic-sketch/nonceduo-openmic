...
export const PromoHeader: React.FC<PromoHeaderProps> = ({ accentColor = 'pink' }) => {
  return (
    <motion.header
    ...
    >
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <a
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#25D366] text-white font-semibold text-sm hover:bg-[#20BD5A] transition-colors"
        >
