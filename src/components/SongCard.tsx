    ...
    return (
      ...
      >
        ...
        <div className="flex gap-2 flex-shrink-0">
            <Button
              onClick={() => onBook(song)}
              className="neon-button-pink text-xs h-9 px-3"
              size="sm"
            >
            ...
            <Button
              ...
              variant="outline"
              className="border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground text-xs h-9 px-3 transition-all"
              size="sm"
            >
