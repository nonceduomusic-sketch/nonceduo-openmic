...
import { ExternalLink, Mic2, Phone, Instagram, Calendar, MapPin, Clock, Music, Users } from "lucide-react";
...
const OpenMicInfo: React.FC = () => {
  const { isLiveSessionActive, isGloballyActive, loading } = useFormatGating('openmic');
