        ...
        <Card className="max-w-md w-full">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-muted-foreground">
              Questo link di accesso al telecomando non è valido o è scaduto. Contatta l'amministratore per un nuovo
              link.
            </p>
          </CardContent>
        </Card>
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardContent className="pt-6 text-center">
            ...
            <Button onClick={() => window.location.reload()}>Riprova accesso</Button>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardHeader className="text-center">
            <img src={brandLogoText} alt="NonceDuo" className="h-12 mx-auto mb-4" />
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 min-h-0 overflow-hidden flex flex-col">
        <div ref={lyricsRef} className="flex-1 overflow-y-auto px-4 py-4 pb-24">
...
// Vista Solo Telecomando - pulsantiera grande (MODIFICATA)
...
function RemoteOnlyControls({
  ...
  // Misura altezza pulsantiera per calcolare padding sicuro sotto
  ...
  return (
    <div className="relative h-full overflow-hidden">
      ...
      <div
        ...
        style={{
          paddingBottom: Math.max(controlsHeight + 64, 220), // spazio extra sotto per ultima riga
          paddingTop: 80, // spazio extra sopra per prima riga e indicatore
        }}
      >
        {/* Indicatore riga corrente (sticky) */}
        ...
        {/* Le righe del testo */}
        <div className="space-y-3 text-center max-w-lg mx-auto pb-8">
          {lines.map((line, index) => {
            const isHighlighted = highlightLine === index;
            ...
            return (
              <div
                ...
                data-line={index}
                className={cn(
                  "px-4 py-3 rounded-xl text-base leading-relaxed transition-colors duration-200",
      ...
      <div ref={controlsRef} className="absolute bottom-0 left-0 w-full bg-card/95 backdrop-blur-xl border-t z-50">
        <div className="p-5 pb-[max(40px, env(safe-area-inset-bottom))] max-w-md mx-auto">
          {/* Barra di progresso */}
